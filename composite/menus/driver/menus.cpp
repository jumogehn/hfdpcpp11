...
int main( int argc, char* argv[] ) {
  ...
  pancake_house_menu->Add( new headfirst::MenuItem(
      ...
      true,
      3.59) );
  diner_menu->Add( new headfirst::MenuItem(
      "Vegetarian BLT",
  ...
  dessert_menu->Add( new headfirst::MenuItem(
      "Apple Pie",
  ...
  dessert_menu->Add( new headfirst::MenuItem(
      ...
      true,
      1.89) );
  cafe_menu->Add( new headfirst::MenuItem(
  ...
  coffee_menu->Add( new headfirst::MenuItem(
      "Coffee Cake",
